...
import '../styles/follow_me_hippo.css'
import { useEffect } from 'react';

export default function FollowMeHippo() {
...
mouthOpen.to('.mouth-back',{duration : mouthSpeed, ease : easeType,y: -65},0);
mouthOpen.to('.tongue',{duration : mouthSpeed*1.5, ease : easeType,y: -70},0);
mouthOpen.to('.teeth',{ duration : mouthSpeed, ease : easeType, y : -65,scaleY:1.2},0);
...
earWiggle.set('.ear-right',{duration:0.1 , rotation : 0 });
earWiggle.set('.ear-left',{transformOrigin:'center center'});
earWiggle.to('.ear-left',{duration:0.1 , rotation : -45 });
earWiggle.set('.ear-left',{duration:0.1 , rotation : 0 });
...
function updateEyePosition(e) {
  ...
  return (
      <div className='flex justify-center my-10'>
          <div className='Hippodiv' id = "hippo" ref={divRef}>
              {/* ///////////////////////////////////// */}
              <svg viewBox="0 0 242 109" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                  <g class="ears">
                      <g class="ear-left">
                          <ellipse class="ear-left-outer" transform="matrix(0.9391 -0.3436 0.3436 0.9391 -3.6062 17.8444)"
                              cx="48.5" cy="19.1" rx="11.4" ry="13.8" />
                          <ellipse class="ear-left-inner" transform="matrix(0.9391 -0.3436 0.3436 0.9391 -3.8876 17.4659)"
                              cx="47.3" cy="19.7" rx="7.3" ry="11.2" />
                      </g>
                      <g class="ear-right">
                          <ellipse class="ear-right-outer" transform="matrix(0.3436 -0.9391 0.9391 0.3436 106.5379 189.869)"
                              cx="189.1" cy="18.7" rx="14.4" ry="11.9" />
                          <ellipse class="ear-right-inner" transform="matrix(0.3436 -0.9391 0.9391 0.3436 106.8522 191.5127)"
                              cx="190.4" cy="19.3" rx="11.7" ry="7.7" />
                      </g>
                  </g>
                  <g class="eyes">
                      {/* /////////////////// */}
