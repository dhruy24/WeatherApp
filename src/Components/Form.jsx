    ...
    return (
        <form onSubmit={handleSubmit} class="my-1">
            ...
            <div class="flex justify-center ">
                <input type="search" id="default-search" value={city} onChange={(e) => setCity(e.target.value)} class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 max-w-[300px]" placeholder="Search Cities..." required></input>
